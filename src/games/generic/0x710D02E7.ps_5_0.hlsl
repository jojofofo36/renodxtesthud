  ...
  out float4 o0 : SV_Target0)
{
  ...
  float4 x1[4];
  float4 x2[4];
  r0.xyzw = MaterialParams_srv_Alpha2texture_0.SampleBias(FrameParams_defaultSamplers_standardSampler_s, v1.zw, PassParams_constants.gradientAdjustMipBias).xyzw;
  x0[0].x = r0.x;
  x0[1].x = r0.y;
  x0[2].x = r0.z;
  x0[3].x = r0.w;
  r0.xyzw = MaterialParams_srv_Layer0Diffuse_1.SampleBias(FrameParams_defaultSamplers_standardSampler_s, v1.xy, PassParams_constants.gradientAdjustMipBias).xyzw;
  x1[0].x = r0.x;
  x1[1].x = r0.y;
  x1[2].x = r0.z;
  x1[3].x = r0.w;
