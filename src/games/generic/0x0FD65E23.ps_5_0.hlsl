  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = MaterialParams_srv.Alpha2texture_0.SampleBias(FrameParams_defaultSamplers_standardSampler_s, r0.yz, PassParams_constants.gradientAdjustMipBias).yzwx;
  r3.x = 1 + -r2.w;
  ...
  r0.xyzw = MaterialParams_srv.Layer0Diffuse_1.SampleBias(FrameParams_defaultSamplers_standardSampler_s, r0.xy, PassParams_constants.gradientAdjustMipBias).yzwx;
  x1[0].x = r0.w;
