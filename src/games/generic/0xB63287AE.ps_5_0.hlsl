  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.y = r0.z * r0.y + 1;
  r0.x = r0.x * r0.y;
  // DIAGNOSTIC : on bypass la lecture du buffer par instance (InstanceParams_instancing_instanceData)
  // qui semble retourner des octets a 0 dans ce contexte RenoDX, et on utilise des valeurs par defaut :
  // - teinte = couleur de base du materiau (pas de recolorisation par instance)
  // - alpha inchange (pas de multiplicateur par instance, equivalent a un multiplicateur de 1)
  r2.xyz = MaterialParams_constants.Layer0Color_33.xyz;
  /*
  r0.y = (uint)v7.x << 3;
  r0.y = (uint)r0.y >> 2;
