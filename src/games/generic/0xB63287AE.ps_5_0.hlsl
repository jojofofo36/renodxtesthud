...
Texture2D<float4> MaterialParams_srv.Layer1Alpha_1 : register(t70);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = MaterialParams_srv.Layer1Alpha_1.SampleBias(FrameParams_defaultSamplers_standardSampler_s, r0.yz, r0.w).xyw;
  ...
  r1.x = -2.5 + r1.x;
  r1.xyzw = MaterialParams_srv.Layer0Diffuse_0.SampleBias(FrameParams_defaultSamplers_standardSampler_s, r0.zw, r1.x).yzwx;
