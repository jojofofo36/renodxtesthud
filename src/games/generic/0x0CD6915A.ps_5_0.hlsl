...
Texture2D<float4> MaterialParams_srv.Layer0Diffuse_0 : register(t69);
Texture2D<float4> MaterialParams_srv.Alpha2texture_0 : register(t70);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = MaterialParams_srv.Alpha2texture_0.SampleBias(FrameParams_defaultSamplers_standardSampler_s, r0.zw, PassParams_constants.gradientAdjustMipBias).xyzw;
  x0[0].x = r1.x;
  x0[1].x = r1.y;
  x0[2].x = r1.z;
  x0[3].x = r1.w;
  ...
  if (r0.y != 0) {
    r0.w = MaterialParams_srv.Layer0Diffuse_0.Sample(FrameParams_defaultSamplers_standardSampler_s, v1.xy).w;
    r3.w = r2.w * r0.w;
    r3.xyz = r2.xyz;
  }
  if (r0.y == 0) {
    ...
    r4.x = MaterialParams_srv.Layer0Diffuse_0.Sample(FrameParams_defaultSamplers_standardSampler_s, v1.xy).w;
    r4.x = 1 + -r4.x;
    ...
    if (r4.y != 0) {
      ...
      if (r5.x != 0) {
        ...
        r5.xy = v1.xy + r5.xy;
        r5.x = MaterialParams_srv.Layer0Diffuse_0.Sample(FrameParams_defaultSamplers_standardSampler_s, r5.xy).w;
        r5.x = 1 + -r5.x;
      } else {
        r5.x = r4.x;
      }
    ...
    if (r0.w != 0) {
      ...
      if (r2.y != 0) {
        ...
        r2.yz = v1.xy + r5.xy;
        r2.y = MaterialParams_srv.Layer0Diffuse_0.Sample(FrameParams_defaultSamplers_standardSampler_s, r2.yz).w;
        r4.x = 1 + -r2.y;
      }
      r2.x = cmp(r2.x < r4.x);
      r0.w = r4.x + -r0.w;
  ...
  r2.x = MaterialParams_srv.Layer0Diffuse_0.Sample(FrameParams_defaultSamplers_standardSampler_s, v1.xy).w;
  r2.x = 1 + -r2.x;
